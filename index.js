...
var _publicJsGlobalsJs = require('./public/js/globals.js');

var glbs = _interopRequireWildcard(_publicJsGlobalsJs);
...
io.on('connection', function (socket) {
    ...
    if (!clients[socket.id]) {
        // If there is a new connection we should save the client id...
        console.log(':! This is a new connection request... ');
        clients[socket.id] = socket;
    }
    socket.on('disconnect', function () {
        // If we receive a disconnection request we should remove the client id...
